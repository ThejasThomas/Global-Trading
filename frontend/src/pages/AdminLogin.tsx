            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6 mb-[30px]">
              ...
              <div className="flex flex-col gap-2">
                ...
                {formik.touched.email && formik.errors.email && (
                  <p className="text-sm text-red-500 font-medium">{formik.errors.email}</p>
                )}
              </div>

              {/* Password Field */}
              <div className="flex flex-col gap-2">
                <label htmlFor="password" className="flex items-center gap-2 font-semibold text-sm text-gray-800 uppercase tracking-wider">
                ...
                {formik.touched.password && formik.errors.password && (
                  <p className="text-sm text-red-500 font-medium">{formik.errors.password}</p>
                )}
              </div>
